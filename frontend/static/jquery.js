...
;(function($){
  ...
  }else if( $(window).width() > 767 && $(window).width() < 901 ){
    $.fn.PicCarousel.defaults = {
      "width":633,		        //幻灯片的宽度
      "height":281,		        //幻灯片的高度
      "posterWidth":500,	        //幻灯片第一帧的宽度
      "posterHeight":281,         //幻灯片第一张的高度
      "scale":0.72,		        //记录显示比例关系
      "speed":300,		        //记录幻灯片滚动速度
      "autoPlay":false,	        //是否开启自动播放
      "delay":500,		        //自动播放间隔
  ...
  }else if( $(window).width() > 413 && $(window).width() < 768 ){
    $.fn.PicCarousel.defaults = {
      "width":385,		        //幻灯片的宽度
      "height":180,		        //幻灯片的高度
      "posterWidth":320,	        //幻灯片第一帧的宽度
      "posterHeight":180,         //幻灯片第一张的高度
      "scale":0.72,		        //记录显示比例关系
      "speed":300,		        //记录幻灯片滚动速度
      "autoPlay":false,	        //是否开启自动播放
      "delay":500,		        //自动播放间隔
  ...
  }else if( $(window).width() > 320 && $(window).width() < 414 ){
    $.fn.PicCarousel.defaults = {
      "width":345,		        //幻灯片的宽度
      "height":163,		        //幻灯片的高度
      "posterWidth":290,	        //幻灯片第一帧的宽度
      "posterHeight":163,         //幻灯片第一张的高度
      "scale":0.72,		        //记录显示比例关系
      "speed":300,		        //记录幻灯片滚动速度
      "autoPlay":false,	        //是否开启自动播放
      "delay":500,		        //自动播放间隔
